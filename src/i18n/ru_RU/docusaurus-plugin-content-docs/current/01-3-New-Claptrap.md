...
Создайте`класс Inventory Update EvenentHandlerв папке  Sku/Events`проекта HelloClaptrap.Actors.
...
Создайте`класс SkuStateInitHandler в папке Sku`проекта HelloClaptrap.actors.
