...
`EventHandler`actualizar eventos alde estado`de Claptrap.Por ejemplo, en este escenario empresarial, EventHandler es responsable de vaciar el contenido del carro de estado.
